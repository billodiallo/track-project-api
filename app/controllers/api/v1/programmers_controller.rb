    ...
    class ProgrammersController < ApplicationController
      ...
      def create
        ...
        if programmer.save
          ...
          render json: {status: 'ERROR', message:'Programmer not saved', data:programmer.errors},status: :unprocessable_entity
        end
      end
      ...
      def update
        ...
        if programmer.update(programmer_params)
          ...
          render json: {status: 'ERROR', message:'Programmer not updated', data:programmer.errors},status: :unprocessable_entity
        end
      end
